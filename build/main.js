	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        React.createElement(Header, {loaded: this.state.response}), 
	        React.createElement("div", {className: "data"}, 
	          React.createElement(Row, {data: this.state.data})
	        )
	      )
	      );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function(root, factory) {
	    if(true) {
	        ...
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function(is) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(8);
	var cn = __webpack_require__(165);

	var Header = React.createClass({displayName: "Header",

	  render: function() {
	    return (
	      React.createElement("div", {className: cn("lr-12 md-12 sm-12 header",{onload: ! this.props.loaded})}, 
	        React.createElement("div", {className: "img-container"}, 
	          React.createElement("img", {id: "sub-logo", src: "../img/livewire.png"})
	        ), 
	    ...
	    return (
	      React.createElement("div", null, 
	          ...
	          data.groups.map(function(data,key){
	            return (
	              React.createElement("div", {className: "row", key: key}, 
	                React.createElement("div", {className: "lr-12 md-12 sm-12 title"}, 
	                  React.createElement("p", null, data.name), 
	                  
	                    data.items.map(function(item,index){
	                      return (
	                        React.createElement("div", {className: "lr-3 md-4 sm-12 same-row data", key: index}, 
	                          React.createElement("div", {className: "container"}, 
	                            React.createElement("div", {className: "contains"}, 
	                            React.createElement("img", {className: "thumbnail", src: item.image, alt: ""}), 
	                            React.createElement("div", {className: "details"}, 
	                              React.createElement("div", {className: "name"}, 
	                                React.createElement("a", {className: "link fancy", target: "_blank", href: item.link}, item.name)
	                              ), 
